...
exports['file.match'] = {
  ...
  'basic matching': function(test) {
    ...
    test.deepEqual(grunt.file.match('*.js', ['foo.js']), ['foo.js'], 'should match correctly.');
    test.deepEqual(grunt.file.match('*.js', ['foo.js', 'bar.style']), ['foo.js'], 'should match correctly.');
    test.deepEqual(grunt.file.match(['*.js', '*.style'], 'foo.js'), ['foo.js'], 'should match correctly.');
    test.deepEqual(grunt.file.match(['*.js', '*.style'], ['foo.js']), ['foo.js'], 'should match correctly.');
    test.deepEqual(grunt.file.match(['*.js', '*.style'], ['foo.js', 'bar.style']), ['foo.js', 'bar.style'], 'should match correctly.');
    test.done();
  },
  'no matches': function(test) {
    test.expect(2);
    test.deepEqual(grunt.file.match('*.js', 'foo.style'), [], 'should fail to match.');
    test.deepEqual(grunt.file.match('*.js', ['foo.style', 'bar.style']), [], 'should fail to match.');
    test.done();
  },
  ...
  'flatten': function(test) {
    test.expect(1);
    test.deepEqual(grunt.file.match([['*.js', '*.style'], ['*.*', '*.js']], ['foo.js', 'bar.style']), ['foo.js', 'bar.style'], 'should process nested pattern arrays correctly.');
    test.done();
  },
...
exports['file.isMatch'] = {
  'basic matching': function(test) {
    ...
    test.ok(grunt.file.isMatch('*.js', ['foo.js']), 'should match correctly.');
    test.ok(grunt.file.isMatch('*.js', ['foo.js', 'bar.style']), 'should match correctly.');
    test.ok(grunt.file.isMatch(['*.js', '*.style'], 'foo.js'), 'should match correctly.');
    test.ok(grunt.file.isMatch(['*.js', '*.style'], ['foo.js']), 'should match correctly.');
    test.ok(grunt.file.isMatch(['*.js', '*.style'], ['foo.js', 'bar.style']), 'should match correctly.');
    test.done();
  },
  'no matches': function(test) {
    test.expect(6);
    test.equal(grunt.file.isMatch('*.js', 'foo.style'), false, 'should fail to match.');
    test.equal(grunt.file.isMatch('*.js', ['foo.style', 'bar.style']), false, 'should fail to match.');
    test.equal(grunt.file.isMatch(null, 'foo.style'), false, 'should fail to match.');
    test.equal(grunt.file.isMatch('*.js', null), false, 'should fail to match.');
    test.equal(grunt.file.isMatch([], 'foo.style'), false, 'should fail to match.');
...
exports['file.expand*'] = {
  ...
  'basic matching': function(test) {
    ...
    test.deepEqual(grunt.file.expand('**/*.js', '**/*.style'), ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'], 'should match.');
    test.deepEqual(grunt.file.expand(['**/*.js', '**/*.style']), ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'], 'should match.');
  ...
  'filter': function(test) {
    ...
    test.deepEqual(grunt.file.expand({filter: 'isFile'}, 'js', 'style'), [], 'should fail to match.');
  ...
  'unique': function(test) {
    ...
    test.deepEqual(grunt.file.expand('**/*.js', '**/*.style', 'js/*.js'), ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'], 'file list should be uniqed.');
  ...
  'file order': function(test) {
    test.expect(4);
    var actual = grunt.file.expand('**/*.{js,style}');
    ...
    actual = grunt.file.expand('js/foo.js', 'js/bar.js', '**/*.{js,style}');
    ...
    actual = grunt.file.expand('js/bar.js', 'js/foo.js', '**/*.{js,style}');
    expected = ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = grunt.file.expand('js/foo.js', '**/*.{js,style}', '!js/bar.js', 'js/bar.js');
    expected = ['js/foo.js', 'style/baz.style', 'style/qux.style', 'js/bar.js'];
    test.deepEqual(actual, expected, 'if a file is excluded and then re-added, it should be added at the end.');
    test.done();
  },
  'flatten': function(test) {
    test.expect(1);
    test.deepEqual(grunt.file.expand([['**/*.js'], ['**/*.style', 'js/*.js']]), ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'], 'should match.');
    test.done();
  },
  'exclusion': function(test) {
    test.expect(8);
    ...
    test.deepEqual(grunt.file.expand(['**/*.js', '**/*.style', '!js/bar.js', '!style/baz.style']), ['js/foo.js','style/qux.style'], 'multiple exclusions should be removed from the set');
    test.deepEqual(grunt.file.expand(['**/*.js', '**/*.style', '!**/*.style']), ['js/bar.js', 'js/foo.js'], 'excluded wildcards should be removed from the matched set');
    test.deepEqual(grunt.file.expand(['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style', '!**/b*.*']), ['js/foo.js', 'style/qux.style'], 'different pattern for exclusion should still work');
    test.deepEqual(grunt.file.expand(['js/bar.js', '!**/b*.*', 'js/foo.js', 'style/baz.style', 'style/qux.style']), ['js/foo.js', 'style/baz.style', 'style/qux.style'], 'inclusion / exclusion order matters');
    test.done();
  },
  'options.matchBase': function(test) {
    test.expect(4);
    ...
    test.deepEqual(grunt.file.expand(opts, '*.js', '*.style'), ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'], 'should match.');
    test.deepEqual(grunt.file.expand(opts, ['*.js', '*.style']), ['js/bar.js', 'js/foo.js', 'style/baz.style', 'style/qux.style'], 'should match.');
    test.done();
  },
...
exports['file.expandMapping'] = {
  ...
  'rename to same dest': function(test) {
    ...
    var expected = [
      ...
      {dest: 'dest/all.style', src: ['expand/style/baz.style', 'expand/style/qux.style']},
...
exports['file'] = {
  ...
  'recurse': function(test) {
    ...
    var expected = {};
    expected[rootdir + '/style/baz.style'] = [rootdir, 'style', 'baz.style'];
    expected[rootdir + '/style/qux.style'] = [rootdir, 'style', 'qux.style'];
